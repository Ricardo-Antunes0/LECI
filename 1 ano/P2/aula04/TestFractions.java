...
public class TestFractions {
  ...
  public static void main(String[] args) {
    ...
    assert z.add(x.add(y)).equals(x.add(z).add(y)); // distributiva adiçao
    // Acrescente testes da comutatividade, associatividade e distributividade
    //...
    assert z.multiply(x).equals(x.multiply(z)); //comutativa 
    assert z.multiply(x.add(y)).equals(z.multiply(x).add(z.multiply(y))); //asssociativa e distributiva
